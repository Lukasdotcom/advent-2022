...
pub fn main() {
    ...
    for x in data {
        ...
        let num1_1: i32 = first_part.get(0).expect("Bad Input").parse().expect("Not a number");
        let num1_2: i32 = first_part.get(1).expect("Bad Input").parse().expect("Not a number");
        let num2_1: i32 = second_part.get(0).expect("Bad Input").parse().expect("Not a number");
        let num2_2: i32 = second_part.get(1).expect("Bad Input").parse().expect("Not a number");
